...
class SicsAlgorithams_AdjListMat_Bidirected {
    adjacency_listmat_bidirectional_tag graph_1;
    adjacency_listmat_bidirectional_tag graph_2;
public:
    SicsAlgorithams_AdjListMat_Bidirected(int num_g, int num_h) : graph_1(num_g), graph_2(num_h) {};
