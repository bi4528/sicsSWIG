...
class SicsAlgorithams_AdjList_Undirected {
    adjacency_list_undirected_tag graph_1;
    adjacency_list_undirected_tag graph_2;
public:
    SicsAlgorithams_AdjList_Undirected(int num_g, int num_h) : graph_1(num_g), graph_2(num_h) {};
