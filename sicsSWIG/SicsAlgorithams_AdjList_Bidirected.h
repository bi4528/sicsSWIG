...
using adjacency_list_bidirectional_tag = sics::adjacency_listmat<uint16_t, sics::bidirectional_tag, std::string>;

class SicsAlgorithams_AdjList_Bidirected {
    adjacency_list_bidirectional_tag graph_1;
    adjacency_list_bidirectional_tag graph_2;
public:
    SicsAlgorithams_AdjList_Bidirected(int num_g, int num_h) : graph_1(num_g), graph_2(num_h) {};
