...
using graph_type = sics::adjacency_listmat<uint16_t, sics::undirected_tag, std::string>;

class SicsAlgorithams_DegreeSortedList_Undirected {
    graph_type graph_1;
    graph_type graph_2;
public:
    SicsAlgorithams_DegreeSortedList_Undirected(int num_g, int num_h) : graph_1(num_g), graph_2(num_h) {};
