...
class SicsAlgorithams_AdjListMat_Undirected {
    adjacency_listmat_undirected_tag graph_1;
    adjacency_listmat_undirected_tag graph_2;
public:
    SicsAlgorithams_AdjListMat_Undirected(int num_g, int num_h) : graph_1(num_g), graph_2(num_h) {};
